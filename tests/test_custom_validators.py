...
class SimpleCustomValidationTestCase(unittest.TestCase):
    ...
    def test_success(self):
        ...
        self.dc1.register_custom_validator(SimpleCustomValidationTestCase.AlwaysValid)
        test1 = Covers()
        self.dc1.add_document_object(test1)
        test1.covers = 1
        self.assertEqual(len(test1.history._edgesbyendnode), 1)
        transaction_test1 = test1.transaction(custom_transaction=SimpleCustomValidationTestCase.AlwaysValid)

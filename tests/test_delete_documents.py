...
class TestDeletion(unittest.TestCase):
    ...
    def test_simple_deletion_parent_in_list(self):
        test = TestFieldListOwner1()
        self.dc1.add_document_object(test)
        test.covers = 17
        testitem = TestFieldListOwner2()
        ...
        self.assertEqual(test._is_deleted, True)
        self.assertEqual(testitem._is_deleted, True)
        test1s = self.dc1.get_by_class(TestFieldListOwner1)
        self.assertEqual(len(test1s), 0)
    ...
    def test_deletion_ancestor_conflict_reversed(self):
        # deletion should lose every conflict where an operation is performed
        # on one of it descendents
        test = TestPropertyOwner1()
        self.dc1.add_document_object(test)
        ...
        test = self.dc2.get_by_class(TestPropertyOwner1)[0]
        test.delete()
        self.assertEqual(test._is_deleted, True)
        test1s = self.dc2.get_by_class(TestPropertyOwner1)
        self.assertEqual(len(test1s), 0)
    ...
    def test_deletion_ancestor_from_list_conflict(self):
        # deletion should lose every conflict where an operation is performed
        # on one of it descendents
        test = TestFieldListOwner1()
        self.dc1.add_document_object(test)
    ...
    def test_deletion_ancestor_from_list_conflict_reversed(self):
        # deletion should lose every conflict where an operation is performed
        # on one of it descendents
        test = TestFieldListOwner1()
        self.dc1.add_document_object(test)
        ...
        test = self.dc2.get_by_class(TestFieldListOwner1)[0]
        test.delete()
        self.assertEqual(test._is_deleted, True)
        test1s = self.dc2.get_by_class(TestFieldListOwner1)
        self.assertEqual(len(test1s), 0)
